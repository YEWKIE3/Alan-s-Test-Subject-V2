const quotes = [
  {
    ...
    selfexplanation: "From the time we're born, we're already dying. That's weird and pretty morbid to think about, but it's important to realize that we're not guaranteed the next step or even the next breath. So we have to live while we're dying."
  },
  {
    quote: "Nothing kills a man faster than his own head ~Trapdoor (Self Titled, 2009)",
    selfexplanation: "We're the only ones standing in the way of everything we want."
  },
  {
    quote: "Please don't be afraid of what your soul is really thinking ~Isle of Flightless Birds (Self Titled, 2009)",
    selfexplanation: "Don't be afraid if your thoughts and opinions don't align with everyone else's. Don't be afraid if you believe in something bigger than yourself."
  },
  {
    quote: "I don't wanna be heard; I want to be listened to ~Forest (Regional at Best, 2011)",
    selfexplanation: "Personally, one of the reasons I don't feel the need to talk much is because I almost never feel like anyone is paying attention to my words. I don't want people to hear what I'm saying and just forget about it or don't care about what I say, I want them to truly listen."
  },
  {
  ...
  { 
    ...
    selfexplanation: "You're not the only one having trouble with life, and this is trying to remind you of that, and to let you know that it's okay to not be okay."
  },
  { 
    ...
    selfexplanation: "I think this has a lot to do with not wanting to be a burden on people and not wanting to make yourself too vulnerable, but then realizing that you can help yourself by letting them in. You don't want to overwhelm them with your problems, but at the same time, they may actually be able to help."
  },
  {
    quote: "I'm so afraid of what you have to say cause I am quiet now and silence gives you space” ~Fake You Out (Vessel, 2013)",
    selfexplanation: "Being yourself putting yourself out there is scary. As soon as I stop talking (or writing), a space opens up for others to pick everything apart and interpret it in their own way, whether it is in the way I intended it to come across or not, which is actually kind of terrifying."
  },
  {
